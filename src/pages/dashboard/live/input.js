...
import {
  ...
  toggleCurrentImgStatusFalse, toggleCurrentModalStatusTrue, toggleCurrentModalStatusFalse } from "../../../store/actions/community";
...
class InputField extends Component {
  static navigationOptions = ({ navigation }) => {
    let reply = navigation.state.params.reply;
    return {
      title: reply === true ? "Reply" : "Add a comment",
      headerTitleStyle: {
        color: 'black'
      },
      headerRight: (
